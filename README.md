...
Personal portfolio of **Naveen Kumar K**, Data Engineer (Bengaluru, India).
A single-page cinematic experience: full-screen scenes stacked on top of
each other, each one rising over the last as you scroll, with scroll-driven
set pieces inside them.

**Profiles:** [LinkedIn](kedin.com/in/naveen-kumar-k-973442398/) · [GitHub](https://github.com/naveenkumark2830-spec/Naveen-Portfolio)
...
## The scenes
1. **Intro** — Three.js gallery tunnel travelled through a name mask
2. **Hero** — headline, stats, CTAs
3. **About** — identity, philosophy, velocity marquee
4. **Journey** — resume chapters: BCA in Data Analytics (2022–2025) → MSc
   Big Data Analytics (2025–2027, expected) → AI/ML Internship at ComedKares
   Innovation Hub — inside a light-cable tunnel
5. **Tech Stack** — tool spiral: Python, SQL, Spark, Kafka, Airflow, AWS,
   Docker, Kubernetes
6. **Work** — 4 selected projects on a perspective card arc, each with a
...
7. **Experience** — one role (AI/ML Intern, ComedKares Innovation Hub) as a
   panel deck
8. **Leadership** — NSS President (2024–2025) and MetaMinds 1.0 Coordinator
   (2025–2026), as panel entries
9. **Connect** — contact, socials, footer
...
content/        typed content: projects, journey, experience, leadership,
                stack
lib/            gsap/lenis integration, i18n store, scene scrub helper, site meta
public/images/  covers, issuer + company marks
```
