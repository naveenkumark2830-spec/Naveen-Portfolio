...
"[project]/components/layout/SmoothScroll.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SmoothScroll({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SmoothScroll.useEffect": ()=>{
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gsap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prefersReducedMotion"])()) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__gsap$3e$__["gsap"].ticker.add(raf);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__gsap$3e$__["gsap"].ticker.lagSmoothing(0);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lenis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setLenis"])(lenis);
            }
            /* delegated: catches every same-page anchor on the site */ const onClick = {
                "SmoothScroll.useEffect.onClick": (e)=>{
                    ...
                    e.preventDefault();
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lenis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scrollToHash"])(href);
                }
            }["SmoothScroll.useEffect.onClick"];
            document.addEventListener("click", onClick);
            /* honour a hash present on first load */ if (window.location.hash) {
                const hash = window.location.hash;
                requestAnimationFrame({
                    "SmoothScroll.useEffect": ()=>setTimeout({
                            "SmoothScroll.useEffect": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lenis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scrollToHash"])(hash)
                        }["SmoothScroll.useEffect"], 60)
                }["SmoothScroll.useEffect"]);
            }
            return ({
                "SmoothScroll.useEffect": ()=>{
                    document.removeEventListener("click", onClick);
                    if (raf) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__gsap$3e$__["gsap"].ticker.remove(raf);
                    lenis?.destroy();
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lenis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setLenis"])(null);
                }
            })["SmoothScroll.useEffect"];
        }
    }["SmoothScroll.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        ...
        fileName: "[project]/components/layout/SmoothScroll.tsx",
        lineNumber: 51,
        columnNumber: 10
    }, this);
}
...
const DICT = {
    ...
    /* ---------------- hero ---------------- */ "hero.kicker": {
        en: "Data Engineer · Big Data & Cloud"
    },
    "hero.h1a": {
        en: "Data that finally"
    },
    "hero.h1aEm": {
        en: "makes sense."
    },
    ...
    "stat.projects": {
        en: "Data Engineering Projects"
    },
    "stat.years": {
        en: "AWS Services Used"
    },
    "stat.countries": {
        en: "Volunteers Led (NSS)"
    },
    "stat.satisfaction": {
        en: "Fest Participants Coordinated"
    },
    /* ---------------- about ---------------- */ "about.eyebrow": {
        en: "About"
    },
    "about.h2a": {
        en: "Data is how I think —"
    },
    "about.h2b": {
        en: "systems are how I"
    },
    "about.h2Em": {
        en: "build"
    },
    ...
    "about.m1": {
        en: "Fest Coordinator, MetaMinds 1.0 — 1,200+ participants"
    },
    "about.m2": {
        en: "Portfolio data engineering projects shipped"
    },
    "about.m3": {
        en: "Terrorism records analyzed into one clean dataset"
    },
    "about.m4": {
        en: "Volunteers led as NSS VP & Treasurer"
    },
    "about.edu": {
    ...
    /* ---------------- journey ----------------
     Chapter copy lives in content/journey.ts; only the chrome is here. */ "journey.eyebrow": {
        en: "My Journey"
    },
    "journey.enter": {
        en: "Scroll to travel"
    ...
    /* ---------------- connect ---------------- */ "connect.eyebrow": {
        en: "Let's Connect"
    },
    "connect.h2a": {
        en: "Let's build what's"
    },
    "connect.h2Em": {
        en: "next."
    },
    ...
    /* ---------------- case study (/work/[slug]) ---------------- */ "case.back": {
        en: "← Back to work"
    },
    "case.kicker": {
        en: "Case Study"
...
function LanguageProvider({ children }) {
    /* Single-language build: no state, no localStorage, no <html lang> writes
     beyond the static "en" already set in the root layout. */ const t = (k)=>DICT[k]?.en ?? k;
...
/* Shared Lenis instance + one place that owns in-page anchor scrolling,
   so the fixed header can never cover the top of a section. */ let instance = null;
const setLenis = (l)=>{
    instance = l;
};
const getLenis = ()=>instance;
...
function scrollToHash(hash) {
    ...
    if (lenis) {
       ...
       keeps the landing position correct here too */ if (toTop) window.scrollTo({
            top: 0
        });
...
//# sourceMappingURL=_0y3j_u8._.js.map